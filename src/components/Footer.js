        ...
        <footer>
            <section>
                ...
                <div>
                    ...
                    <ul>
                        <li className='footer-btn'><a href='/'>Home</a></li>
                        <li className='footer-btn'><a href='/booking'>Reservations</a></li>
                        <li className='footer-btn'><a href='/menu'>Order Online</a></li>
                        <li className='footer-btn'><a href='/menu'>Menu</a></li>
                    </ul>
                </div>
